     ...
     { // Initialization
          ...
          for (i = 0; i <= 7; i++)
          {
               ...
               { // neutron, proton alpha
                    dname = INPUTDIR + pname[i] + "/solar-dep.inp";
               }
               else if (i == 3)
               {
                    dname = INPUTDIR + pname[i] + "/solar-dep-EL.inp";
               }
               else if (i == 4)
               {
                    dname = INPUTDIR + pname[i] + "/solar-dep-PO.inp";
               }
               else if (i == 5)
               {
                    dname = INPUTDIR + pname[i] + "/solar-dep-PH.inp";
               }
               else if (i == 6)
               {
                    dname = INPUTDIR + pname[i] + "/solar-dep.plus";
               }
               else if (i == 7)
               {
                    dname = INPUTDIR + pname[i] + "/solar-dep.mins";
               }
          ...
          dname = INPUTDIR + "ions/solar-dep.inp";
...
// *******************************************************
{
     ...
     { // Initialization
          ifirst = 1;
          dname = INPUTDIR + "neutro/correction-depth-rigid.inp";
          ifstream ifs(dname, ios::in);
          getline(ifs, str); // Kara-yomi
...
// *******************************************************
{
     ...
     if (p[1] == 0)
     { // Initialization
          dname = INPUTDIR + "neutro/Geo-Dep.inp";
          ifstream ifs1(dname, ios::in);
          getline(ifs1, str); // Kara-yomi
          getline(ifs1, str); // Read p(1)-p(3)
          istringstream s1(str);
          s1 >> p[1] >> p[2] >> p[3];
          dname = INPUTDIR + "neutro/Water-Dep.inp";
          ...
          dname = INPUTDIR + "neutro/Aircraft-Dep.inp";
...
// *******************************************************
{
     ...
     if (B[2] == 0.0)
     { // first time
          dname = INPUTDIR + "neutro/Depth-Dep-mid.out";
          ifstream ifs(dname, ios::in);
          getline(ifs, str); // Kara-yomi
          getline(ifs, str); // Kara-yomi
          getline(ifs, str);
          ...
          dname = INPUTDIR + "neutro/Rigid-Dep.inp";
          ifstream ifs1(dname, ios::in);
          getline(ifs1, str); // Kara-yomi
          getline(ifs1, str); // Kara-yomi
          getline(ifs1, str); // Kara-yomi
...
// *******************************************************
{
     ...
     if (B[4] == 0.0)
     { // first time
          dname = INPUTDIR + "neutro/Depth-Dep-hig.out";
          ifstream ifs(dname, ios::in);
          getline(ifs, str); // Kara-yomi
          getline(ifs, str); // Kara-yomi
          getline(ifs, str);
...
// *******************************************************
{
     ...
     { // Initialization
          ...
          for (i = 0; i <= npart; i++)
          {
               if (i == 0)
               {
                    dname = INPUTDIR + "neutro/bestR.inp";
               }
               else
               {
                    dname = INPUTDIR + "elemag/bestR-" + pname[i] + ".inp";
               }
               ifstream ifs(dname, ios::in);
               getline(ifs, str); // Kara-yomi
               for (id = 1; id <= ndep; id++)
...
// *******************************************************
{
     ...
     { // Initialization
          ...
          for (i = 0; i <= 5; i++)
          {
               if (i <= 2)
               {
                    dname = INPUTDIR + pname[i] + "/Rigid-Dep.inp"; // neutron, proton, alpha
               }
               else if (i == 3)
               {
                    dname = INPUTDIR + pname[i] + "/Rigid-Dep-EL.inp"; // electron
               }
               else if (i == 4)
               {
                    dname = INPUTDIR + pname[i] + "/Rigid-Dep-PO.inp"; // positron
               }
               else if (i == 5)
               {
                    dname = INPUTDIR + pname[i] + "/Rigid-Dep-PH.inp"; // photon
               }
               ifstream ifs(dname, ios::in);
               getline(ifs, str); // Kara-yomi
               for (ib = 1; ib <= nBdata; ib++)
          ...
          dname = INPUTDIR + "ions/Rigid-Dep.inp";
          ifstream ifs1(dname, ios::in);
          for (i = npart - 5; i <= npart; i++)
          {
               getline(ifs1, str);
...
// *******************************************************
{
     ...
     { // first time, get universal parameter (i.e: independent of all parameters)
          //      Read A parameter
          dname = INPUTDIR + "neutro/fitting-lowspec.inp";
          ifstream ifs(dname, ios::in);
          getline(ifs, str); // Kara-yomi
          getline(ifs, str);
          istringstream s(str);
...
// *************************************************************
{
     ...
     { // Initialization
          ...
          {
               dname = INPUTDIR + "ions/primary-" + gname[ig] + ".inp";
               ifstream ifs(dname, ios::in);
               getline(ifs, str); // Kara-yomi
               for (id = 1; id <= ndep; id++)
               {
          ...
          dname = INPUTDIR + "ions/dEdx-table.inp";
          ifstream ifs1(dname, ios::in);
          getline(ifs1, str); // Kara-yomi
          getline(ifs1, str); // Kara-yomi
          getline(ifs1, str);
...
// *******************************************************
{
     ...
     { // Initialization
          ...
          for (i = 1; i <= 5; i++)
          {
               if (i == 1)
               {
                    dname = INPUTDIR + "proton/fitting-lowspec.inp";
               }
               else if (i == 2)
               {
                    dname = INPUTDIR + "alphaa/fitting-lowspec.inp";
               }
               else if (i == 3)
               {
                    dname = INPUTDIR + "elemag/fitting-lowspec-EL.inp";
               }
               else if (i == 4)
               {
                    dname = INPUTDIR + "elemag/fitting-lowspec-PO.inp";
               }
               else if (i == 5)
               {
                    dname = INPUTDIR + "elemag/fitting-lowspec-PH.inp";
               }
               ifstream ifs(dname, ios::in);
               getline(ifs, str); // Kara-yomi
               for (id = 1; id <= ndep; id++)
          ...
          dname = INPUTDIR + "ions/fitting-lowspec.inp";
          ifstream ifs1(dname, ios::in);
          getline(ifs1, str); // Kara-yomi
          for (i = npart - 5; i <= npart; i++)
          {
...
// *******************************************************
{
     ...
     { // Initialization
          ifirst = 1;
          dname = INPUTDIR + "ions/Combine.inp";
          ifstream ifs(dname, ios::in);
          getline(ifs, str); // Kara-yomi
          for (i = 1; i <= ngroup; i++)
          {
...
// *******************************************************
{
     ...
     { // Initialization
          ...
          {
               dname = INPUTDIR + "muon--/final135." + charge[ip2];
               ifstream ifs1(dname, ios::in);
               getline(ifs1, str); // Kara-yomi
               ...
               dname = INPUTDIR + "muon--/final2467." + charge[ip2];
               ifstream ifs2(dname, ios::in);
               getline(ifs2, str); // Kara-yomi
               for (id2 = 1; id2 <= ndep; id2++)
               {
...
// *******************************************************
{
     ...
     { // Initialization
          ifirst = 1;
          dname = INPUTDIR + "angle/NeutronGround.out";
          ifstream ifs(dname, ios::in);
          for (i = 1; i <= maxfit; i++)
          {
               getline(ifs, str);
...
// *******************************************************
{
     ...
     { // Initialization
          ...
          for (ip2 = 1; ip2 <= npart; ip2++)
          {
               dname = INPUTDIR + "angle/BkH-" + pname[ip2] + ".inp";
               ifstream ifs(dname, ios::in);
               getline(ifs, str); // Kara-yomi
               for (i = 1; i <= nBHpara; i++)
               {
...
// *******************************************************
{
     ...
     { // Initialization
          ...
          {
               dname = INPUTDIR + "angle/" + pname[ip1] + ".out";
               ifstream ifs1(dname, ios::in);
               getline(ifs1, str); // Kara-yomi
               for (i = 1; i <= maxfit; i++)
               {
               ...
               dname = INPUTDIR + "angle/" + pname[ip1] + "-Eint.out";
               ifstream ifs2(dname, ios::in);
               getline(ifs2, str); // Kara-yomi
               for (is = 1; is <= nsur; is++)
               {
...
// ************************************************
{
     ...
     { // Initialization
          ifirst = 1;
          dname = INPUTDIR + "FFPtable.day"; // Read daily force potential
          ifstream ifs(dname, ios::in);
          getline(ifs, str);
          istringstream s(str);
          s >> iystart >> iyend;
          ...
          dname = INPUTDIR + "FFPtable.uso"; // Read annual force field potential
          ifstream ifs1(dname, ios::in);
          getline(ifs1, str);
          istringstream s1(str);
          s1 >> iysUs >> iyeUs;
...
// ******************************************************
{
     ...
     { // Initialization
          ifirst = 1;
          dname = INPUTDIR + "CORdata.inp"; // Read vertical cut-off rigidity database
          ifstream ifs(dname, ios::in);
          getline(ifs, str);
          istringstream s(str);
...
// ******************************************************
{
     ...
     { // Initialization
          ifirst = 1;
          dname = INPUTDIR + "AtomDepth.inp"; // Read vertical cut-off rigidity database
          ifstream ifs(dname, ios::in);
          getline(ifs, str); // kara-yomi
...
// ******************************************************
{
     ...
     { // Initialization
          ifirst = 1;
          dname = INPUTDIR + "elemag/flux511keV.inp";
          ifstream ifs(dname, ios::in);
          getline(ifs, str); // Kara-yomi
          for (id = 1; id <= ndep; id++)
          {
